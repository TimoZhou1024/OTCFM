...
% \textbf{Fourth}, even unsupervised alignment methods often rely on combinatorial optimization (e.g., Hungarian algorithm with $O(N^3)$ complexity), severely limiting scalability to large-scale datasets.
